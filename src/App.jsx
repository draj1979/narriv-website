...
import WhyVartaVerse from './components/WhyVartaVerse';
    ...
    <div className="app">
      ...
      <nav style={{ position: 'absolute', top: 0, left: 0, width: '100%', padding: '1.5rem', zIndex: 10, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          <img src="/logo.jpg" alt="VartaVerse Logo" style={{ width: '32px', height: '32px', borderRadius: '4px', objectCover: 'cover' }} />
          <div style={{ fontWeight: 'bold', fontSize: '1.5rem' }}>VartaVerse</div>
        </div>
